...
func StartApp() error {
	...
	privatePEM, err := os.ReadFile(`C:\Users\Bhoomika\Downloads\job-portal-api-main\job-portal-api-main\private.pem`)
	if err != nil {
	...
	publicPEM, err := os.ReadFile(`C:\Users\Bhoomika\Downloads\job-portal-api-main\job-portal-api-main\pubkey.pem`)
	if err != nil {
